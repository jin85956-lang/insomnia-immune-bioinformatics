...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20251895.svg)](https://doi.org/10.5281/zenodo.20251895)
...
Portions of the code in this repository were developed with the assistance of generative AI tools (Anthropic Claude, OpenAI ChatGPT) for code-snippet suggestions and debugging support. All analytical design choices, parameter selections, biological interpretations, and output validation were performed by the repository author. See the corresponding manuscript Acknowledgements section for the full disclosure.
