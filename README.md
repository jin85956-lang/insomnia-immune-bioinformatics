...
|---|---|---|
| GSE208668 (microarray, PBMC) | https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE208668 | (insert your access date) |
| GSE39445, GSE98566, GSE56931 (cross-cohort) | https://www.ncbi.nlm.nih.gov/geo | (insert) |
| eQTLGen Phase I cis-eQTL | https://www.eqtlgen.org/ | (insert) |
| Jansen 2019 Insomnia GWAS | https://ctg.cncr.nl/software/summary_statistics | (insert) |
| CIBERSORTx LM22 reference | https://cibersortx.stanford.edu | (insert) |
| DGIdb v5.x | https://dgidb.org | (insert) |
| 1000 Genomes EUR LD reference (for SMR) | https://yanglab.westlake.edu.cn/software/smr/ | (insert) |
...
```
Chen X. et al. (2026). Insomnia Immune–Stress Bioinformatics — Supplementary Code (v1.0.0)
...
or contact \[corresponding author email\].
